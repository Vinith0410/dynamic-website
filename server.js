...
app.get('/add', isAdmin, (req, res) => res.sendFile(path.join(__dirname, '/public/admin/page/add.html')));
app.get('/add-product', isAdmin, (req, res) => res.sendFile(path.join(__dirname, '/public/admin/product/product.html')));
app.get('/controls', isAdmin, (req, res) => res.sendFile(path.join(__dirname, '/public/admin/common/navbar.html')));
...
app.get('/category', isAdmin, (req, res) => res.sendFile(path.join(__dirname, '/public/admin/category/category.html')));
app.get('/rippon', isAdmin, (req, res) => res.sendFile(path.join(__dirname, '/public/admin/rippon/rippon.html')));
app.get('/listcategory', isAdmin, (req,res)=>res.sendFile(path.join(__dirname, '/public/admin/category/listcategory.html')));
app.get('/listproduct', isAdmin, (req,res)=>res.sendFile(path.join(__dirname, '/public/admin/product/listproduct.html')));
app.get('/edit-product', isAdmin, (req,res)=>res.sendFile(path.join(__dirname, '/public/admin/product/edit-product.html')));
app.get('/list', isAdmin, (req,res)=>res.sendFile(path.join(__dirname, '/public/admin/page/list.html')));
app.get('/deleted', isAdmin, (req,res)=>res.sendFile(path.join(__dirname, '/public/admin/restore/deleted.html')));
app.get('/listrippon', isAdmin, (req, res) =>res.sendFile(path.join(__dirname, '/public/admin/rippon/listrippon.html')));
